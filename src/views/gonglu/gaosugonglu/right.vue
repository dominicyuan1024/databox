...
export default {
  ...
  computed: {
    ...
    chart2() {
      const data = [
        { name: "桩基", value: 50, color: "#089E74", border: "#3FA9F5" },
        { name: "墩柱", value: 20, color: "#51AAE2", border: "#3FA9F5" },
        { name: "梁板预制", value: 40, color: "#4EC6C6", border: "#00FFFF" },
        { name: "梁板安装", value: 60, color: "#0C7FFF", border: "#29ABE2" }
      ];
      const option = {
        title: {
          text: "桥梁工程",
